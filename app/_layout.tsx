...
function RootNavigator() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="clinic/chat-archive-patient-picker" options={{ headerShown: false }} />
      <Stack.Screen name="clinic/patient-archive" options={{ headerShown: false }} />
      ...
      <Stack.Screen name="clinic/photo-editor" options={{ headerShown: false, presentation: 'fullScreenModal', animation: 'slide_from_bottom' }} />
      ...
      <Stack.Screen name="patient/session-detail" options={{ headerShown: false }} />
