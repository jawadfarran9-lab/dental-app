...
export const COUNTRIES: Country[] = [
  ...
  { code: 'BS', name_en: 'Bahamas', name_ar: 'جزر البهاما' },
  ...
  { code: 'BY', name_en: 'Belarus', name_ar: 'بيلاروس' },
  ...
  { code: 'TL', name_en: 'East Timor', name_ar: 'تيمور الشرقية' },
  ...
  { code: 'GA', name_en: 'Gabon', name_ar: 'الجابون' },
  ...
  { code: 'LU', name_en: 'Luxembourg', name_ar: 'لوكسمبرغ' },
  ...
  { code: 'FM', name_en: 'Micronesia', name_ar: 'ميكرونيزيا' },
  ...
  { code: 'MK', name_en: 'North Macedonia', name_ar: 'شمال مقدونيا' },
  ...
  { code: 'CD', name_en: 'Republic of the Congo', name_ar: 'جمهورية الكونغو' },
  ...
  { code: 'ST', name_en: 'Sao Tome and Principe', name_ar: 'سان تومي وبرينسيبي' },
  ...
  { code: 'SX', name_en: 'Sint Maarten', name_ar: 'سينت مارتن' },
  ...
  { code: 'VA', name_en: 'Vatican City', name_ar: 'مدينة الفاتيكان' },
